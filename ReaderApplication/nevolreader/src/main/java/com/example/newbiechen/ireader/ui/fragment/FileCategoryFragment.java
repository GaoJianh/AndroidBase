...
public class FileCategoryFragment extends BaseFileFragment {
    ...
    protected void initWidget(Bundle savedInstanceState) {
        ...
        mTvPath = getActivity().findViewById(R.id.file_category_tv_path);
        mTvBackLast = getActivity().findViewById(R.id.file_category_tv_back_last);
        mRvContent = getActivity().findViewById(R.id.file_category_rv_content);
        setUpAdapter();
    }
