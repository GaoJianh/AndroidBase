...
public class BookDetailActivity extends BaseMVPActivity<BookDetailContract.Presenter>
    ...
    protected void initWidget() {
        ...
        mIvCover = findViewById(R.id.book_detail_iv_cover);
        mTvTitle = findViewById(R.id.book_detail_tv_title);
        mTvAuthor = findViewById(R.id.book_detail_tv_author);
        mTvType = findViewById(R.id.book_detail_tv_type);
        mTvWordCount = findViewById(R.id.book_detail_tv_word_count);
        mTvLatelyUpdate = findViewById(R.id.book_detail_tv_lately_update);
        mTvChase = findViewById(R.id.book_list_tv_chase);
        mTvRead = findViewById(R.id.book_detail_tv_read);
        mTvFollowerCount = findViewById(R.id.book_detail_tv_follower_count);
        mTvRetention = findViewById(R.id.book_detail_tv_retention);
        mTvDayWordCount = findViewById(R.id.book_detail_tv_day_word_count);
        mTvBrief = findViewById(R.id.book_detail_tv_brief);
        mTvMoreComment = findViewById(R.id.book_detail_tv_more_comment);
        mRvHotComment = findViewById(R.id.book_detail_rv_hot_comment);
        mRvCommunity = findViewById(R.id.book_detail_rv_community);
        mTvCommunity = findViewById(R.id.book_detail_tv_community);
        mTvPostsCount = findViewById(R.id.book_detail_tv_posts_count);
        mTvRecommendBookList = findViewById(R.id.book_list_tv_recommend_book_list);
        mRvRecommendBookList = findViewById(R.id.book_detail_rv_recommend_book_list);
    }
