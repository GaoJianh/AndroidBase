...
/*    @BindView(R.id.search_rv_history)
    ...
    protected void initWidget() {
        ...
        mEtInput = findViewById(R.id.search_et_input);
        mIvDelete = findViewById(R.id.search_iv_delete);
        mIvSearch = findViewById(R.id.search_iv_search);
        mTvRefreshHot = findViewById(R.id.search_book_tv_refresh_hot);
        mTgHot = findViewById(R.id.search_tg_hot);
